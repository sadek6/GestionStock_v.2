...
public class ReclamationController implements Initializable {
    ...
    ObservableList<String> idetat =FXCollections.observableArrayList("Urgente","Non urgente");
    ObservableList<String> idtype =FXCollections.observableArrayList("Commerciale","Ressource humaine","Financiere");
    /**
    ...
    public void initialize(URL url, ResourceBundle rb) {
         etat.setItems(idetat);
         type.setItems(idtype);
        // TODO
    }    
    @FXML
    private void ajte(ActionEvent event) {
         ...
         //  se.ajouter2(new Reclamation(desc.getText(),etat.getSelectionModel().getSelectedItem(),type.getSelectionModel().getSelectedItem(),datecons,"e"));
