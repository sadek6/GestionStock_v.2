    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        niv.setItems(niveau);
         ...
         id.setCellValueFactory(
            new PropertyValueFactory<Chauffeur,Integer>("numpass")
        );
...
//        tableUsers.setItems(sortedData);
        ...
        chercher.textProperty().addListener((obsVal, oldValue, newValue) -> {
            filteredData.setPredicate(Chauffeur -> {
              ...
              else if ( String.valueOf(Chauffeur.getNumpass()).indexOf(lowercasefilter) != -1  )
                return true;
            else return false ;
  ...
  id.setCellValueFactory(
   ...
   String requete = "UPDATE chauffeur SET numpass='"+id+"',Prenom='"+pren+"'"
